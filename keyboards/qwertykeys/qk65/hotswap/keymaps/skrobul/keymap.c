...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_65_ansi_blocker(
        ...
        SC_LSPO,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SC_RSPC, KC_UP,   MO(1),
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        KC_TRNS,          KC_SLEP, KC_TRNS, TMUXCOPY, TMUXPASTE, KC_TRNS, TMUXNEXT, TMUXPREV, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
